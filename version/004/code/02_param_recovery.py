...
"""
1. Simulate Subjects
    a. create values array for each subject (same number as experimental trials)
    Simulate a trial for each value

2. Fit subjects to RT dist (MLE)

3. Check quality of fit
"""
